...
import { ChevronLeft, ArrowLeft, ChevronRight, Compass, Database, Cpu, Layers } from 'lucide-react';
    ...
    <div className="mt-32 pt-12 border-t border-ink/10">
      <div className="flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {pages.filter(p => p.path !== '/modern/digital').map(p => (
            <button
              key={p.path}
...
const Digital: React.FC<DigitalProps> = ({ language }) => {
  const router = useRouter();
