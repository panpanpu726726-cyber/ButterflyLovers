               ...
               <div className={`relative aspect-video w-full flex items-center justify-center p-0 ${index % 2 === 1 ? 'md:-translate-x-6' : 'md:translate-x-6'}`}>
                  ...
                  >
                    ...
                    {index === 0 ? (
                      ...
                      <img
                        src="/assets/images/legend/legend-ch3.png"
                        alt="Legend of Liang Zhu – Chapter 3"
                        className="w-full h-full object-cover"
                      />
                    ) : index === 3 ? (
                      <img
                        src="/assets/images/legend/legend-ch4.png"
                        alt="Legend of Liang Zhu – Chapter 4"
                        className="w-full h-full object-cover"
                      />  
                    ) : (
      ...
      <footer className="mt-60 relative max-w-7xl mx-auto px-8 text-center z-10">
        ...
        <div className="max-w-2xl mx-auto space-y-10">
          <motion.p 
            ...
            className="text-white font-serif text-xl md:text-2xl italic leading-relaxed opacity-70 px-6"
          >
            {language === 'en' 
